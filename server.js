...
// ================= OPS CHECK =================
app.get("/jfs-ops-check", async (req, res) => {
  ...
  try {
    ...
    const clean =
      allRecords.map(item => ({
        ...
        network:
          item.checkNetworkName || "",

        networkCode:
          item.checkNetworkCode || "",
...
// ================= OPS CHECK DETAIL =================
app.get("/jfs-ops-check-detail", async (req, res) => {
